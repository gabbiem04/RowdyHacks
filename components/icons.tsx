...
export const PiggyBankIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M10 2a8 8 0 0 1 5.23 14.12L21 21l-1.41-1.41a8 8 0 1 1-9.59-9.59V2Zm.5 11.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/>
    <path d="M2 18c.2-.5.5-1 1-1.5 2.5-2.5 5.5-2.5 8 0"/>
    <path d="M12 18c.2-.5.5-1 1-1.5 2.5-2.5 5.5-2.5 8 0"/>
  </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M5 21l1.5-3L8 16.5 6.5 15 5 21z"/>
    <path d="M19 21l-1.5-3L16 16.5l1.5-1.5L19 21z"/>
  </svg>
);
